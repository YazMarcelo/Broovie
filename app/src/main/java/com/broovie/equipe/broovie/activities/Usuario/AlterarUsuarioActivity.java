...
public class AlterarUsuarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Nome = (EditText)findViewById(R.id.alt_txtNome);
        Email = (EditText)findViewById(R.id.alt_txtEmail);
        DataNascimento = (EditText)findViewById(R.id.alt_txtDataNascimento);
        Pais = (EditText)findViewById(R.id.alt_txtPais);
        NomeUsuario = (EditText)findViewById(R.id.alt_txtNomeUsuario);
    ...
    public void alterarUsuario(View view) {
        ...
        final Usuario user = Usuario.builder()
                ...
                .pais(Pais.getText().toString())
                .nomeUsuario(NomeUsuario.getText().toString()).build();
